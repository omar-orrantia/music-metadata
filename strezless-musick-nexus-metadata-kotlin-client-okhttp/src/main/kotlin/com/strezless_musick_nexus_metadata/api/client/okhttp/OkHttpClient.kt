...
import com.strezless_musick_nexus_metadata.api.core.http.HttpRequestBody
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw StrezlessMusickNexusMetadataIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("STREZLESS_MUSICK_NEXUS_METADATA_LOG")?.lowercase()) {
