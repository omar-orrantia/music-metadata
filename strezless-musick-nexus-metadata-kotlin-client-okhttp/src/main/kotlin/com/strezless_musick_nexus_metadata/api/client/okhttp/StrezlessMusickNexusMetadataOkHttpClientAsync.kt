...
import com.strezless_musick_nexus_metadata.api.client.StrezlessMusickNexusMetadataClientAsyncImpl
...
/**
 * A class that allows building an instance of [StrezlessMusickNexusMetadataClientAsync] with
 * [OkHttpClient] as the underlying [HttpClient].
 */
class StrezlessMusickNexusMetadataOkHttpClientAsync private constructor() {
    ...
    companion object {
         ...
         */
        fun fromEnv(): StrezlessMusickNexusMetadataClientAsync = builder().fromEnv().build()
    }

    /** A builder for [StrezlessMusickNexusMetadataOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [StrezlessMusickNexusMetadataClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StrezlessMusickNexusMetadataClientAsync =
