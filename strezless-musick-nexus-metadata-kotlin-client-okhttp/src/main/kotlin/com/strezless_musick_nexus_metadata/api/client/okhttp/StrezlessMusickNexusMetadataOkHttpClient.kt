...
package com.strezless_musick_nexus_metadata.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.strezless_musick_nexus_metadata.api.client.StrezlessMusickNexusMetadataClient
import com.strezless_musick_nexus_metadata.api.client.StrezlessMusickNexusMetadataClientImpl
import com.strezless_musick_nexus_metadata.api.core.ClientOptions
import com.strezless_musick_nexus_metadata.api.core.Sleeper
import com.strezless_musick_nexus_metadata.api.core.Timeout
import com.strezless_musick_nexus_metadata.api.core.http.Headers
import com.strezless_musick_nexus_metadata.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [StrezlessMusickNexusMetadataClient] with
 * [OkHttpClient] as the underlying [HttpClient].
 */
class StrezlessMusickNexusMetadataOkHttpClient private constructor() {
    ...
    companion object {
         ...
         */
        fun fromEnv(): StrezlessMusickNexusMetadataClient = builder().fromEnv().build()
    }

    /** A builder for [StrezlessMusickNexusMetadataOkHttpClient]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.strezless_musick_nexus_metadata.api.core.jsonMapper]. The default is
        ...
        /**
         * Returns an immutable instance of [StrezlessMusickNexusMetadataClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StrezlessMusickNexusMetadataClient =
            StrezlessMusickNexusMetadataClientImpl(
                clientOptions
                    .httpClient(
