...
import com.strezless_musick_nexus_metadata.api.errors.StrezlessMusickNexusMetadataException
    ...
    try {
        ...
        { observed, close ->
            try {
                ...
                throw StrezlessMusickNexusMetadataException(
                    "Unexpected reflective invocation failure",
                    e,
                )
            }
        }
