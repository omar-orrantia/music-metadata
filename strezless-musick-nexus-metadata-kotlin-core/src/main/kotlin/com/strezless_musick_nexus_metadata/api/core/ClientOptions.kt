...
package com.strezless_musick_nexus_metadata.api.core
...
import com.strezless_musick_nexus_metadata.api.core.http.PhantomReachableClosingHttpClient
import com.strezless_musick_nexus_metadata.api.core.http.QueryParams
import com.strezless_musick_nexus_metadata.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `strezless-musick-nexus-metadata-kotlin-client-okhttp` or implement
     * your own.
     *
     ...
     *
     * Defaults to [com.strezless_musick_nexus_metadata.api.core.jsonMapper]. The default is usually
    ...
    class Builder internal constructor() {
         ...
         * The HTTP client to use in the SDK.
         *
         * Use the one published in `strezless-musick-nexus-metadata-kotlin-client-okhttp` or
         * implement your own.
         *
         * This class takes ownership of the client and closes it when closed.
         */
