...
/**
 * A client for interacting with the Strezless Musick Nexus Metadata REST API asynchronously. You
 * can also switch to synchronous execution via the [sync] method.
 *
 ...
 * may call [close].
 */
interface StrezlessMusickNexusMetadataClientAsync {
     ...
     * this client.
     */
    fun sync(): StrezlessMusickNexusMetadataClient
    ...
    /**
     * A view of [StrezlessMusickNexusMetadataClientAsync] that provides access to raw HTTP
