...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.strezless_musick_nexus_metadata.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.strezless_musick_nexus_metadata.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.strezless_musick_nexus_metadata.api.** {
    <init>(...);
