...
dependencies {
    testImplementation(project(":strezless-musick-nexus-metadata-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../strezless-musick-nexus-metadata-kotlin-core/src/main/resources/META-INF/proguard/strezless-musick-nexus-metadata-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.strezless_musick_nexus_metadata.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../strezless-musick-nexus-metadata-kotlin-core/src/main/resources/META-INF/proguard/strezless-musick-nexus-metadata-kotlin-core.pro",
